...
#define WHITE_KING_CASTLES_KING_POS 58
#define WHITE_QUEEN_CASTLES_KING_POS 62
#define WHITE_KING_CASTLES_ROOK_POS 59
#define WHITE_QUEEN_CASTLES_ROOK_POS 61

#define BLACK_KING_CASTLES_KING_POS 2
#define BLACK_QUEEN_CASTLES_KING_POS 6
#define BLACK_KING_CASTLES_ROOK_POS 3
#define BLACK_QUEEN_CASTLES_ROOK_POS 5

#define FIRST_CHECKED_PIECE 0
#define SECOND_CHECKED_PIECE 1
#define MAX_CHECKED_PIECES 2

#define WHITE_EN_PASSANT_ROW 3
#define BLACK_EN_PASSANT_ROW 4
